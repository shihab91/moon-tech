	...
	return (
		<div className='max-w-7xl gap-14 mx-auto my-10'>
			<div className='mb-10 flex justify-end gap-5'>
				<button className={`border px-3 py-2 rounded-full font-semibold ${stock ? activeClass : ''} `} onClick={() => dispatch(toggleStock())}>
					In Stock
				</button>
				...
				<button className={`border px-3 py-2 rounded-full font-semibold ${brands.includes('intel') ? activeClass : ''} `} onClick={() => dispatch(toggleBrand('intel'))}>
					Intel
				</button>
			</div>
